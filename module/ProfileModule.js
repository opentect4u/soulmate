...
const user_groom_loc = (data) =>{
    return new Promise (async (resolve, reject) => {
        var select =
            ...
            table_name = "td_user_education a LEFT JOIN md_education b ON a.heigh_education=b.id LEFT JOIN  md_occupation c ON a.occup=c.id  LEFT JOIN md_income d ON a.income=d.id LEFT JOIN md_cities e ON a.work_location=e.id LEFT JOIN td_user_profile f",
