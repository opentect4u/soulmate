...
ProfileRouter.post('/user_basic_info', async (req, res) => {
    ...
    var table_name = 'td_user_profile',
        fields = data.user_id > 0 ? `u_name = '${data.field_name}', phone_no = '${data.field_mobile}', ac_for = '${data.field_who_creat_profile}', mother_tong = '${data.field_mother_tong}', gender = '${data.field_gender}', modified_by = '${data.user}', modified_dt = '${datetime}'` : '(u_name, phone_no, ac_for, mother_tong, created_by, created_dt)',
